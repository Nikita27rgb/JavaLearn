public class Model {
    ...
    public String toString() {
        return new StringBuilder(getClass().getName()).append(" [").append(brand).append(", ").append(model + ", max speed: ").append(maxSpeed)
                .append(", weight: " + weight + ", length: " + length + ", width: " + width + ", wheels: " + countWheel).append("]").toString();
    }
}

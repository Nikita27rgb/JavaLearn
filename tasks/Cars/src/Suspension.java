public class Suspension {
	...
	public Suspension(String type, double springRate, double damperRate, double groundClearance) {
		setSuspension(type, springRate, damperRate, groundClearance);
	}
	...
	public void setSuspension(String type, double springRate, double damperRate, double groundClearance) {
		this.type = type;
